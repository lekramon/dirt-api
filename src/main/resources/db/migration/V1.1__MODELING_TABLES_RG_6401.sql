...
(
    IDT_ACCOUNT        NUMBER(38) GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE) PRIMARY KEY,
...
(
    IDT_TRANSACTION          NUMBER(38) GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE) PRIMARY KEY,
    NUM_IP                   VARCHAR2(15)  NOT NULL,
    NUM_AMOUNT               NUMBER(14, 2) NOT NULL,
    NUM_TAX                  NUMBER(12, 2) NOT NULL,
    ...
    CONSTRAINT IDT_ACCOUNT FOREIGN KEY (IDT_ACCOUNT) REFERENCES ACCOUNT (IDT_ACCOUNT)
);